...
related files and scripts to pre-process genomic data generated at the [Duke-GCB Sequencing Core](https://genome.duke.edu/cores-and-services/sequencing-and-genomic-technologies) in [DCC](https://oit-rc.pages.oit.duke.edu/rcsupportdocs/about/).

Example of usage for data generated by Genewiz:
```
$ ggr_cwl_ipynb_gen \
  --root-dir /path/to/rootdir \
  --metadata examples/processing_metadata_template_dcc.xlsx \
...
For usage with Genewiz, please fill out all the values in the [Genewiz metadata spreadsheet](examples/processing_metadata_template_dcc.xlsx) 
...
optional arguments:
  ...
  --data-from {dukeds,sftp,miseq,other,local}
                        Choices: dukeds, sftp, miseq, other, local, genewiz
